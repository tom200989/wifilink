 ...
 */
public class GetConnectHotSpotStateParam implements Serializable {
    ...
    public GetConnectHotSpotStateParam() {
    }

    public GetConnectHotSpotStateParam(String hotspotId, String SSID, int securityMode, String key, int hidden) {
        HotspotId = hotspotId;
        this.SSID = SSID;
