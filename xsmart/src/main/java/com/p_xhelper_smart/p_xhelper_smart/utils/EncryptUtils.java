...
public class EncryptUtils {
    ...
    public static String encryptToken(String token, String tokenKey, String tokenIv, String deviceName) {
        ...
        // 3.判断设备
        if (SmartUtils.getDevTokenType(deviceName) == XCons.ENCRYPT_DEV_ROUTER) {// 老设备Token加密方式
            return builder.toString();

        } else if (SmartUtils.getDevTokenType(deviceName) == XCons.ENCRYPT_DEV_HOTSPOT) {// 新设备Token加密方式
