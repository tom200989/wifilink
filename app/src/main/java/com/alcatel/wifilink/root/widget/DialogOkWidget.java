 ...
 */
public class DialogOkWidget extends RelativeLayout {

    private String TAG = "DialogOkWidget";
    ...
    public DialogOkWidget(Context context) {
        this(context, null, 0);
    }

    public DialogOkWidget(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DialogOkWidget(Context context, AttributeSet attrs, int defStyle) {
