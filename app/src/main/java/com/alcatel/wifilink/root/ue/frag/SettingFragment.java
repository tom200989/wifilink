...
public class SettingFragment extends Fragment implements View.OnClickListener, FragmentBackHandler {
    ...
    private DialogOkWidget dgSettingRxWidgetOk;
    private DialogOkWidget dgSettingRxWidgetConfirm;
    private View m_view;
    ...
    private void init() {
        ...
        dgSettingRxWidgetOk = (DialogOkWidget) m_view.findViewById(R.id.dg_settingRx_widget_ok);
        dgSettingRxWidgetConfirm = (DialogOkWidget) m_view.findViewById(R.id.dg_settingRx_widget_confirm);
