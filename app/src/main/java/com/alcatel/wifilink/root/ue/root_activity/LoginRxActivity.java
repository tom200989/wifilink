...
// TOGO 2019/8/17 0017 login,login_mw,login_mw_device
@Deprecated
public class LoginRxActivity extends BaseActivityWithBack {
    ...
    // TOGO 2019/8/16 0016 通过login_mw_device分流
    private void initAdapter() {
        // ** 初始化设备列表适配器
        LinearLayoutManager devicesLlm = new LinearLayoutManager(this, 1, false);
        devicesAdapter = new LoginMWDevAdapter(this, null);
    ...
    private void startPreTimer() {
        preTimer = new TimerHelper(this) {
            ...
            public void doSomething() {
                xGetSystemStatusHelper.getSystemStatus();// 获取与网络相关(信号强度,网络类型)
    ...
    // TOGO 2019/8/16 0016 通过login_mw分流
    /**
    ...
    // TOGO 2019/8/16 0016 通过统一定时器机制处理
    @Override
    ...
    public void onBackPressed() {
        ...
        if (rlLoginDevices.getVisibility() == View.VISIBLE) {
            ...
            xGetSystemInfoHelper.setOnFwErrorListener(() -> exit());
            xGetSystemInfoHelper.setOnAppErrorListener(() -> exit());
            xGetSystemInfoHelper.getSystemInfo();
        }
    }
    ...
    @OnClick({R.id.rl_login_remenberPsd,// 记住密码
            ...
            R.id.rl_login_pre_connected,// 切换至连接
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_login_backToPre:// 返回
                showLoginPreOrNot(true);
                break;
            // TOGO 2019/8/16 0016 使用login_mw分流
            ...
            case R.id.rl_login_pre_freesharing:// 切换至free sharing
                ...
                break;
            // TOgo 2019/8/16 0016 使用login_mw_device分流
    ...
    // TOGO 2019/8/16 0016 clicklogin
    ...
    // TOGO 2019/8/16 0016 savepassword
    ...
    private void putRemberPassword() {
        ...
        if (isRemem) {
            SP.getInstance(this).putString(Cons.LOGIN_RXPSD, RootUtils.getEDText(etLoginRx));
        } else {
            SP.getInstance(this).putString(Cons.LOGIN_RXPSD, "");
        }
    }

    // TOGO 2019/8/16 0016 tologin
    ...
    // TOGO 2019/8/16 0016 getConnmode
    ...
    private void getConnectMode() {
        ...
        xGetWanSettingsHelper.setOnGetWanSettingsSuccessListener(result -> {
            ...
            xGetSimStatusHelper.setOnGetSimStatusSuccessListener(bean -> {
                ...
                boolean simflag = simState == GetSimStatusBean.CONS_SIM_CARD_READY || simState == GetSimStatusBean.CONS_PIN_REQUIRED || simState == GetSimStatusBean.CONS_PUK_REQUIRED;
                OtherUtils.hideProgressPop(pgd);
    ...
    // TOGO 2019/8/16 0016 getWanerror
    ...
    // TOGO 2019/8/16 0016 to_wizard_home
    ...
    // TOGO 2019/8/16 0016 showResetUI
    ...
    // TOGO 2019/8/16 0016 login_mw -- getSystemStatusError
