...
import com.alcatel.wifilink.root.ue.frag.MobileNetworkRxFragment;
import com.alcatel.wifilink.root.ue.frag.PinRxFragment;
import com.alcatel.wifilink.root.ue.frag.PukRxFragment;
import com.alcatel.wifilink.root.ue.frag.SetDataPlanRxfragment;
import com.alcatel.wifilink.root.ue.frag.SettingFragment;
import com.alcatel.wifilink.root.ue.frag.SmsFragments;
import com.alcatel.wifilink.root.ue.frag.UsageRxFragment;
import com.alcatel.wifilink.root.ue.frag.WifiExtenderRxFragment;
import com.alcatel.wifilink.root.ue.frag.WifiFragment;
import com.alcatel.wifilink.root.ue.frag.mainRxFragment;
    ...
    private void startSmsMessageTimer() {
        smsTimer = new TimerHelper(this) {
            ...
            public void doSomething() {
                ...
                XXXSHelper.setOnResultErrorListener(error -> showUnreadDot(false));
                XXXSHelper.setOnErrorListener(e -> showUnreadDot(false));
