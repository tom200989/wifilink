...
import com.alcatel.wifilink.root.ue.activity.InternetStatusActivity;
...
public class mainRxFragment extends Fragment implements FragmentBackHandler {
    ...
    DialogOkWidget dgMainrxWidgetOk;// 确定取消面板
    ...
    private void ShowMW120Ui(boolean isMW120) {
        ...
        if (isMW120) {
            ...
            // rlMainrxMw70BottomPanel.setOnClickFreeSharingListener(o -> to(FreeSharingActivity.class, false));
