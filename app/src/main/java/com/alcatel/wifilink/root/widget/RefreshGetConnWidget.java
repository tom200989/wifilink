 ...
 */
public class RefreshGetConnWidget extends RelativeLayout {

    private ImageView ivRefreshGetconnectBg;
    private TextView tvRefreshGetconnectOk;

    public RefreshGetConnWidget(Context context) {
        this(context, null, 0);
    }

    public RefreshGetConnWidget(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RefreshGetConnWidget(Context context, AttributeSet attrs, int defStyleAttr) {
