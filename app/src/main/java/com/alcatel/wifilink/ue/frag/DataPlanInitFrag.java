...
import com.alcatel.wifilink.widget.HH70_DataUnitWidget;
...
public class DataPlanInitFrag extends BaseFrag {
    ...
    private void initRes() {
        ...
        MB = getRootString(R.string.hh70_mb);
        GB = getRootString(R.string.hh70_gb);
    }
    ...
    private void adapterRussia() {
        ...
        if (language.contains(RootCons.LANGUAGES.RUSSIAN)) {
