...
public class LoginFrag extends RootFrag {
    ...
    private void showResetUI() {
        ...
        wdResetFactory.setDes(R.string.hh70_operate_reset_restore);
    ...
    private void checkWps() {
        ...
        wpsHelper.setOnGetWPSSuccessListener(isWPS -> {
            if (isWPS) toFragActivity(getClass(), HomeActivity.class, mainFrag.class, null, true);
            else toFrag(getClass(), WifiInitFrag.class, null, true);
        });
    ...
    private void getWanError() {
        ...
        xGetSystemInfoHelper.setOnFwErrorListener(() -> toast(R.string.hh70_cant_login, 5000));
        xGetSystemInfoHelper.setOnAppErrorListener(() -> toast(R.string.hh70_cant_login, 5000));
        xGetSystemInfoHelper.getSystemInfo();
    }
